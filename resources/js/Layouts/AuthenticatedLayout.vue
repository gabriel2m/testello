                    ...
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            <div v-if="$page.props.flash.message" class="alert">
                                <div class="flex p-4 mb-4 text-blue-800 border-t-4 border-blue-300 bg-blue-50"
                                    role="alert">
                                    <div class="ml-3 text-sm font-bold">
                                        {{ $page.props.flash.message }}
                                    </div>
                                    <button type="button"
                                        class="ml-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-500 p-1.5 hover:bg-blue-200 inline-flex h-8 w-8"
